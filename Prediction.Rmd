...
```{r}
training <- read.csv("/Users/Lauren/Documents/Data Science Coursera/Prediction/pml-training.csv", na.strings=c("#DIV/0!"), row.names = 1)
testing <- read.csv("/Users/Lauren/Documents/Data Science Coursera/Prediction/pml-testing.csv", na.strings=c("#DIV/0!"), row.names = 1)
```
